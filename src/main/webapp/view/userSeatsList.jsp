...
<head>
	...
	function initTable(){
		...
		$('#dataList').datagrid({
			...
			fit: true,//自动大小
			method: "post",
			url:"UserSeatsServlet?oper=getUserSeatsList&t="+new Date().getTime(),
			idField:'id',
...
<body>
	...
	<div id="toolbar" style="border-color: #dddddd;background: #F4F4F4;height: auto;padding: 1px 2px;border-width: 0 0 1px 0;border-style: solid;color: #000000;text-align: left">
		<div style="margin-top: 3px;">
			...
			用户账号：
			<td><input id="searchUsername" style="width: 150px;height: 30px;" class="easyui-textbox" type="text"/></td>
			状态：
